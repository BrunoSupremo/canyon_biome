-- local log = radiant.log.create_logger('Canyon_add_as_terrain')
local Canyon_add_as_terrain = class()
local Point3 = _radiant.csg.Point3
local Cube3 = _radiant.csg.Cube3
local Region3 = _radiant.csg.Region3
local rng = _radiant.math.get_default_rng()

function Canyon_add_as_terrain:post_activate()
...
function Canyon_add_as_terrain:_on_world_generation_complete()
